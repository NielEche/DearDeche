...
<div class="container pt-1 pb-2 footer">
    <div class="row">
       {{--  <div style="display:flex; justify-content:space-between;">
            <div style="display:flex;" class="px-4">
                <a class="px-2" href="https://www.instagram.com/deardeche/" target="_blank">
            ...
            <div class="px-4">
                <a href="{{route('contact')}}">
                    <p class="MAK text-black text-decoration-none">Contact Us</p>
                </a>
            </div>
        </div> --}}
        <a ><p class="MAK f-12 text-center  text-black text-decoration-none"> © 2021 by DearDeche</p></a>
    </div>
</div>